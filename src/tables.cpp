...
extern int general_store(int), armory(int), weaponsmith(int), temple(int),
  alchemist(int), magic_shop(int);

/* Each store will buy only certain items, based on TVAL */
int (*store_buy[MAX_STORES])(int) = { // JG: I added int instead of void here.
