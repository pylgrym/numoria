...
/* If compiling on Debian (also works on other versions of Linux), 
   define this. */
#define DEBIAN_LINUX_NO_ITS_NOT
...
// it was supposed to become a char buffer variable,
// where we print FILES/MORIATOP/SCORES?
...
#else
#if defined(GEMDOS) || defined(PC_JG)
/* Atari ST */
#define MORIA_SAV	"moria.sav"
// JG: I don't want moria hours..
// JG: #define MORIA_HOU	"files\\hours"
