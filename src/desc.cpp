...
void magic_init()
{
  ...
  bool permuteFlavor = false; // JG: I don't want permute, I want rememberable attributes/flavor.. same colors, etc.
  if (permuteFlavor) {
  ...
  // Permute the store-owners, I don't mind..
