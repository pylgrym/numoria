...
int CMainFrame::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
	...
	const int ms100 = 100;
	m_wndView.SetTimer(timerID, ms100, NULL);
...
BOOL CMainFrame::PreCreateWindow(CREATESTRUCT& cs)
{
  ...
  which would give us 1920/64 = 30 pixels per sprite. 
  Hmm, still not 32 pixels :-(
  Maybe 2560 pixels wide will save us..
  60 columns allows 32 in 1920.
  */
